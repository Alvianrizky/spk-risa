      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="l_Keputusan.php"><i class="fa fa-circle-o"></i> Rekap Rekomendasi</a></li>
        </li>
      </ul>
    </section>
    <!-- /.sidebar -->
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Rekap Rekomendasi</li>
      </ol>
    </section>
    ...
    <section class="content">
      <div class="row">
        ...
        <form role="form" method="post" action="lap_rekomendasirekapjabatan.php" onsubmit="return validasi(this)">
          <div class="box">
