...
//ProsesCetak
	...
	//$now = date('Y-m-d-His');
	//$now2 = date('d-m-Y');
	$filename ="Laporan Rekomendasi Rekap Jabatan.pdf";
  ...
  select a.id_calon_karyawan, b.nm_calon_karyawan, c.nm_jabatan, MAX(total) as total from hasil a, calon_karyawan b, jabatan c
  where a.id_calon_karyawan = b.id_calon_karyawan and a.id_jabatan = c.id_jabatan and a.periode = '$periode' and
  (a.id_jabatan, total) IN (
		  SELECT a.id_jabatan, MAX(total)
		  FROM hasil
		  GROUP BY id_calon_karyawan)
...
<tr>
        ...
        <h5 align='center'>LAPORAN REKOMENDASI REKAP PENERIMAAN CALON KARYAWAN <br>
	...
	<table cellpadding='0' cellspacing='1' style='width: 210mm;' border=0.5 align='center'>
		<tr align='center' bgcolor='#CCCCCC'>
			...
			<th style='width: 150px; height: 20px'>Nama Jabatan</th>
