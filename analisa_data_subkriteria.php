          ...
          <div class="box">
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                ?>
                <?php
                  $a="select a.id_subkriteria, a.nm_subkriteria, b.nm_kriteria, a.id_kriteria, count(a.id_kriteria) as total_sub, CASE
                  WHEN a.id_subkriteria not in(select id_subkriteria_1 from banding_subkriteria) THEN 'Belum dihitung'
                  ELSE 'Sudah dihitung'
                  End as ket from subkriteria a, kriteria b where a.id_kriteria = b.id_kriteria group by a.id_kriteria HAVING total_sub > 1";
                  ...
                  ?>
                    <tr>
                      ...
                      <td>
                        <a href="analisa_subkriteria.php?id_kriteria=<?php echo $c['id_kriteria'];?>"><i class="glyphicon glyphicon-arrow-right"></i></a>&nbsp;&nbsp;
                      </td>
                    </tr>
                    <?php $no++; } ?>
                </tbody>
