...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Penjurusan
        <small>Hasil Penjurusan</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a href="#">Penjurusan </a></li>
        <li class="active">Hasil Penjurusan</li>
      </ol>
    </section>
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <?php
                  ...
                  WHEN a.id_jabatan not in(select id_jabatan from banding) THEN 'Belum dihitung'
                  ELSE 'Sudah dihitung'
                  End as ket
                  from jabatan a
                  ...
                  ?>
                    <tr>
                      ...
                      <td>
                        <a href="cek_alternatif.php?id_jabatan=<?php echo $c['id_jabatan'];?>"><i class="fa fa-eye"></i></a>&nbsp;&nbsp;
                      </td>
                    </tr>
                    <?php $no++; } ?>
                </tbody>
