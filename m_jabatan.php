        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <a class="btn btn-success" href="a_jabatan.php">Tambah Data</a>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                ?>
                <?php
                  $a="select * from jabatan order by id_jabatan";
                  ...
                  ?>
                    <tr>
                      ...
                      <td>
                        <a href="e_jabatan.php?id_jabatan=<?php echo $c['id_jabatan'];?>"><i class="fa fa-edit"></i></a>&nbsp;&nbsp;
                                                
                      <a href="javascript:if(confirm('Yakin ingin menghapus data?'))
                      {document.location='d_jabatan.php?id_jabatan=<?php echo $c['id_jabatan']; ?>';}">
