...
alert('Data belum lengkap !');
    ...
    $a="insert into subkriteria values('$id_subkriteria','$id_kriteria','$nm_subkriteria')";
            ...
            <form role="form" method="post">
              <div class="box-body">
                <div class="form-group">
                  <label for="inputEmail3" class="col-sm-2 control-label">Id SubKriteria</label>

                  <div class="col-sm-4">
                    <input type="text" name="id_subkriteria" class="form-control" placeholder="Id SubKriteria" value="<?=autonumber("subkriteria","id_subkriteria",2,"SKRT")?>" readonly>
                  </div>
                </div>
                <br><br>
                <div class="form-group">
