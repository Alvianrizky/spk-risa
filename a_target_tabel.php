...
include 'koneksi.php';
    ...
    $nilai = $_POST['NL'];
    $status = $_POST['status'];
    $jumlah_dipilih = count($id_jabatan);

    for($x=0;$x<$jumlah_dipilih;$x++){

       $query_multiinsert="INSERT INTO target values ('$id_jabatan[$x]','$id_subkriteria[$x]','$periode[$x]','$nilai[$x]','$status[$x]')";
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="m_target.php"><i class="fa fa-circle-o"></i> Profil Jabatan</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="#">Data</a></li>
        <li class="active">Profil Jabatan</li>
      </ol>
    </section>
    ...
    <section class="content">
          ...
          <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <?php
                  ...
                  $a="select a.nm_jabatan, b.nm_subkriteria, c.target, c.status from jabatan a, subkriteria b, target c where a.id_jabatan = c.id_jabatan and 
      ...
      <a class="btn btn-danger" href="javascript:if(confirm('Yakin ingin mereset data?'))
                      {document.location='d_profilejabatan.php?id_jabatan=<?php echo $id_jabatan; ?>';}">
                      Reset Data</a>
      </div>
