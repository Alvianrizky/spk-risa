    ...
    <div class="wrapper">
            ...
            <section class="sidebar">
                ...
                <ul class="sidebar-menu" data-widget="tree">
                    ...
                    <li class="treeview">
                        ...
                        <ul class="treeview-menu">
                            <li><a href="analisa_data_alternatif.php"><i class="fa fa-circle-o"></i> Analisa
                                    Alternatif</a></li>
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <h1>
                    Data Laporan
                    <small>Perhitungan Kriteria</small>
                </h1>
                <ol class="breadcrumb">
                    <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
                    <li><a href="#">Data Laporan</a></li>
                    <li class="active">Perhitungan Kriteria</li>
                </ol>
            </section>
            ...
            <section class="content">
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <form role="form" method="post" action="lap_perhitungan_kriteria.php">
                            <div class="box">
                        ...
                        <form role="form" method="post" action="lap_profilejabatan.php"
                        ...
                        <form role="form" method="post" action="lap_rankingjabatan.php"
                            onsubmit="return validasi(this)">
                            <div class="box">
                                <div class="box-header">
                        ...
                        <section class="content-header">
                            <h1>
                                Data Laporan
                                <small>Rekap Rekomendasi</small>
                            </h1>

                        </section>
                        <form role="form" method="post" action="lap_rekomendasirekapjabatan.php"
                            onsubmit="return validasi(this)">
                            <div class="box">
                                <div class="box-header">
