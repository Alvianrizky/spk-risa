          ...
          <div class="box">
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                ?>
                <?php
                  $a="SELECT a.id_jabatan, a.nm_jabatan, CASE
                  WHEN a.id_jabatan not in(select id_jabatan from target) THEN 'Belum dihitung'
                  ELSE 'Sudah dihitung'
                  End as ket
                  from jabatan a
                  ...
                  ?>
                    <tr>
                      <td><?php echo $no;?></td>
                      <td><?php echo $c['id_jabatan'];?></td>
                      <td><?php echo $c['nm_jabatan'];?></td>
                      <td><?php echo $c['ket'];?></td>
                      <td>
                        <a href="a_target.php?id_jabatan=<?php echo $c['id_jabatan'];?>"><i class="glyphicon glyphicon-arrow-right"></i></a>&nbsp;&nbsp;
                      </td>
                    </tr>
                    <?php $no++; } ?>
                </tbody>
