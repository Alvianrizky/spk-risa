...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Data
        <small><a href="a_target_tabel.php?id_jabatan=<?php echo $id_jabatan;?>">Profile Jabatan</small></a>
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a href="#">Data </a></li>
        <li class="active"><a href="a_target_tabel.php">Profil Jabatan</li></a>
      </ol>
    </section>
    ...
    <section class="content">
      <div class="row">
        ...
        <div class="col-xs-12">
          ...
          <form role="form" method="post" action="a_target_tabel.php?id_jabatan=<?php echo $id_jabatan;?>">
          <div class="box-body">
