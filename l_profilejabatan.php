        ...
        <li class="active treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="l_perhitungan_kriteria.php"><i class="fa fa-circle-o"></i> Perhitungan Kriteria</a></li>
			      <li class="active"><a href="l_profilejabatan.php"><i class="fa fa-circle-o"></i> Rekap Profile Jabatan</a></li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="row">
		...
		<form role="form" method="post" action="lap_profilejabatan.php" onsubmit="return validasi(this)">
          <div class="box">
