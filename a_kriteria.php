...
alert('Data belum lengkap !');
    ...
    $a="insert into kriteria values('$id_kriteria','$nm_kriteria','0')";
            ...
            <form role="form" method="post">
              <div class="box-body">
                <div class="form-group">
                  ...
                  <div class="col-sm-4">
                    <input type="text" name="id_kriteria" class="form-control" placeholder="Id Kriteria" value="<?=autonumber("kriteria","id_kriteria",2,"KRIT")?>" readonly>
                  </div>
                </div>
                <br><br>
                <div class="form-group">
                  ...
                  <div class="col-sm-4">
                    <input type="text" name="nm_kriteria" class="form-control" placeholder="Nama Kriteria">
                  </div>
                </div>
                <div class="form-group">
