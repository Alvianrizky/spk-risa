...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Analisa
        <small><a href="analisa_target_tabel.php?id_jurusan=<?php echo $id_jurusan;?>">Analisa Target</small></a>
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a href="#">Analisa </a></li>
        <li class="active"><a href="analisa_kriteria_tabel.php">Analisa Target</li></a>
      </ol>
    </section>
      ...
      <div class="row">
        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            ...
            <!-- /.box-header -->
            <h4>&nbsp;&nbsp;&nbsp;&nbsp;<label>Jurusan <?php echo $data['nm_jurusan'];?></label></h4>
            <div class="col-xs-12 col-md-4">
            <div class="form-group">
            <h4><label>Sub Kriteria</label></h4>
            </div>
            </div>
            ...
            <div class="col-xs-12 col-md-4">
            <div class="form-group">
            <h4><label>Nilai Target</label></h4></strong>
            </div>
            </div>
          ...
          <form role="form" method="post" action="analisa_target_tabel.php?id_jurusan=<?php echo $id_jurusan;?>">
          <div class="box-body">
          ...
          $jumlah = $data['total_subkriteria'];

          for($a=1; $a<=$jumlah; $a++)
          {
          ?>
          <input type="hidden" name="periode[]" class="form-control" value="<?php echo date('Y'); ?>">
          <input type="hidden" name="id_jurusan[]" class="form-control" value="<?php echo $id_jurusan; ?>">
            <div class='col-xs-12 col-md-4'>
              <div class='form-group'>
