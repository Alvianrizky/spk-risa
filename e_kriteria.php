...
$eigenvector_kriteria=$_POST['eigenvector_kriteria'];
    if (empty($nm_kriteria)){
      echo "<script language='javascript'>
alert('Data belum lengkap !');
</script>";
    }else{
    $a="update kriteria set nm_kriteria='$nm_kriteria', eigenvector_kriteria='$eigenvector_kriteria' where id_kriteria='$id_kriteria'";
    $c="update kriteria_temp set nm_kriteria='$nm_kriteria', eigenvector_kriteria='$eigenvector_kriteria' where id_kriteria='$id_kriteria'";
            ...
            <form role="form" method="post">
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-4">
                    <input type="text" name="eigenvector_kriteria" class="form-control" placeholder="Nilai Eigen Vector" value="<?php echo $data['eigenvector_kriteria'];?>" readonly>
                  </div>
                </div>
                <div class="form-group">
