        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <a class="btn btn-success" href="a_calon_karyawan.php">Tambah Data</a>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                ?>
                <?php
                  $a="select * from calon_karyawan order by id_calon_karyawan";
                  ...
                  ?>
                    <tr>
                      ...
                      <td>
                        <a href="e_calon_karyawan.php?id_calon_karyawan=<?php echo $c['id_calon_karyawan'];?>"><i class="fa fa-edit"></i></a>&nbsp;&nbsp;
                                                
                      <a href="javascript:if(confirm('Yakin ingin menghapus data?'))
                      {document.location='d_calon_karyawan.php?id_calon_karyawan=<?php echo $c['id_calon_karyawan']; ?>';}">
