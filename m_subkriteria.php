        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <a class="btn btn-success" href="a_subkriteria.php">Tambah Data</a>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                ?>
                <?php
                  $a="select * from subkriteria a, kriteria b where a.id_kriteria = b.id_kriteria order by a.id_subkriteria";
                  ...
                  ?>
                    <tr>
                      <td><?php echo $no;?></td>
                      <td><?php echo $c['id_subkriteria'];?></td>
                      <td><?php echo $c['nm_subkriteria'];?></td>
                      <td><?php echo $c['nm_kriteria'];?></td>
                      <td><?php echo $c['eigenvector_sub'];?></td>
                      <td>
                        <a href="e_subkriteria.php?id_subkriteria=<?php echo $c['id_subkriteria'];?>"><i class="fa fa-edit"></i></a>&nbsp;&nbsp;
                        <a href="javascript:if(confirm('Yakin ingin menghapus data?'))
                      {document.location='d_subkriteria.php?id_subkriteria=<?php echo $c['id_subkriteria']; ?>';}">
