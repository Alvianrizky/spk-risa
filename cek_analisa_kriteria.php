      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="cek_analisa_kriteria.php"><i class="fa fa-circle-o"></i> Analisa Alternatif</a></li>
        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <h4>Pilih Kriteria Penilaian Alternatif</h4>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <?php
                  $periode = date('Y');
                  $a="select a.id_kriteria, a.nm_kriteria, a.eigenvector_kriteria,
                      case when a.id_kriteria not in(select id_kriteria from banding_ada) then
                      'Belum Dihitung'
                      else
                      'Sudah Dihitung'
                      end as 'KET'
                      from kriteria a, banding_kriteria b
                      where a.id_kriteria = b.id_kriteria_1
                  ...
                  ?>
                    <tr>
                      ...
                      <td>
                        <a href="analisa_alternatif.php?id_kriteria=<?php echo $c['id_kriteria'];?>"><i class="fa fa-edit"></i></a>                    
                      </td>
                    </tr>
                    <?php $no++; } ?>                       
                </tbody>
