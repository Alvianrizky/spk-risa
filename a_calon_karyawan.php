...
$alamat=$_POST['alamat'];
$jenkel=$_POST['jenkel'];
    if (empty($id_calon_karyawan) or empty($nm_calon_karyawan) or empty($no_telp) or empty($jenkel) or empty($alamat)){
      echo "<script language='javascript'>
alert('Data belum lengkap !');
</script>";
    }else{
    $a="insert into calon_karyawan values('$id_calon_karyawan','$nm_calon_karyawan','$jenkel','$no_telp','$alamat')";
    $b=mysqli_query($koneksi,$a);
      if ($b) {
        echo "<script language='javascript'>
        alert('Data Calon Karyawan berhasil disimpan');
        </script>";
      }
    }
  }
        ...
        <div class="col-xs-12">
          ...
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title">Tambah Data Calon Karyawan</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" method="post">
              <div class="box-body">
                <div class="form-group">
                  ...
                  <div class="col-sm-4">
                    <input type="text" name="id_calon_karyawan" class="form-control" placeholder="ID Calon Karyawan" value="<?=autonumber("calon_karyawan","id_calon_karyawan",3,"CKRY")?>" readonly >
                  </div>
                </div>
                <br><br>
                <div class="form-group">
                  ...
                  <div class="col-sm-4">
                    <input type="text" name="nm_calon_karyawan" class="form-control" placeholder="Nama Calon Karyawan">
                  </div>
                </div>
                <br><br>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-4">
                    <input type="text" name="no_telp" class="form-control" placeholder="No. Telphone">
                  </div>
                </div>
                <br><br>
                <div class="form-group">
