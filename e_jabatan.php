...
alert('Data belum lengkap !');
    ...
    $a="update jabatan set nm_jabatan='$nm_jabatan' where id_jabatan='$id_jabatan'";
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="m_jabatan.php"><i class="fa fa-circle-o"></i> Jabatan</a></li>
            ...
            <form role="form" method="post">
              <div class="box-body">
                <div class="form-group">
                  <label for="inputEmail3" class="col-sm-2 control-label">Id Jabatan</label>

                  <div class="col-sm-4">
                    <input type="text" name="id_jabatan" class="form-control" placeholder="Id Jabatan" value="<?php echo $data['id_jabatan'];?>" readonly>
                  </div>
                </div>
                <br><br>
                <div class="form-group">
                  <label for="inputPassword3" class="col-sm-2 control-label">Nama Jabatan</label>

                  <div class="col-sm-4">
                    <input type="text" name="nm_jabatan" class="form-control" placeholder="Nama Jabatan" value="<?php echo $data['nm_jabatan'];?>">
                  </div>
                </div>
                <br><br>
                <div class="form-group">
