        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <a class="btn btn-success" href="a_kriteria.php">Tambah Data</a>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
                ...
                <?php
                  ...
                  ?>
                    <tr>
                      ...
                      <td><?php echo $c['eigenvector_kriteria'];?></td>
                      <td>
                        <a href="e_kriteria.php?id_kriteria=<?php echo $c['id_kriteria'];?>"><i class="fa fa-edit"></i></a>&nbsp;&nbsp;
                                                
                      <a href="javascript:if(confirm('Yakin ingin menghapus data?'))
                      {document.location='d_kriteria.php?id_kriteria=<?php echo $c['id_kriteria']; ?>';}">
